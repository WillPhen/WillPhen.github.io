// @STEPS: Input pre-encrypted text file into letter frequency program.
// @STEPS:

// @STRUCTURE
//       @INTRODUCTION: All the historical and technical information.
//       @LETTER FREQUENCY: Demonstrate letter frequency using pre-encrypted large text file.
//            "E" will be the most frequent text.
//       @WORD FREQUENCY: Demonstrate letter frequency using pre-encrypted large text file.
//            Articles will be the most frequent
//       @WORD MATCH:
//            1. Input prospective word.
//            2. Press submit.
//            3. Input dictionary.
//            4. Output list of possible words following that pattern.
